 ...
 */
class Note extends \Note implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Note' . "\0" . 'id', '' . "\0" . 'Note' . "\0" . 'title', '' . "\0" . 'Note' . "\0" . 'content', '' . "\0" . 'Note' . "\0" . 'createDate', '' . "\0" . 'Note' . "\0" . 'creator', '' . "\0" . 'Note' . "\0" . 'meeting');
        }
