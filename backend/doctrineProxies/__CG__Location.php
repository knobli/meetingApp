 ...
 */
class Location extends \Location implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Location' . "\0" . 'id', '' . "\0" . 'Location' . "\0" . 'name', '' . "\0" . 'Location' . "\0" . 'signInObjects');
        }
